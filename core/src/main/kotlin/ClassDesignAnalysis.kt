...
class ClassDesignAnalysis(
    ...
    private fun classStatusMatch() = AnalysisOutput(
        AnalysisTag.STATUS,
    ...
    private fun classModifiersMatch() = AnalysisOutput(
    ...
    private fun superClassesMatch() = AnalysisOutput(
    ...
    private fun publicFieldsMatch() = AnalysisOutput(AnalysisTag.FIELDS, run {
