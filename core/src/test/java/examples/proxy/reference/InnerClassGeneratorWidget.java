...
public class InnerClassGeneratorWidget {
  ...
  @Helper private static int runnableRuns = 0;

  @Helper private static Runnable[] lastRunnerHolder;

  @Helper private static NamedInner lastNamedInner;

  @Helper static int innerRuns = 0;
  ...
  public static InnerClassGeneratorWidget generate(int complexity, Random random) {
    ...
    class LocalRunnable implements Runnable {
      ...
      public void run() {
        runnableRuns++;
        lastNamedInner =
            new NamedInner(new InnerClassGeneratorWidget(random.nextInt(complexity + 1)));
  ...
  public static void verify(
      TestOutput<InnerClassGeneratorWidget> ours, TestOutput<InnerClassGeneratorWidget> theirs) {
