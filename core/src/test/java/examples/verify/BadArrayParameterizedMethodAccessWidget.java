...
public class BadArrayParameterizedMethodAccessWidget {
  ...
  public static BadArrayParameterizedMethodAccessWidget generate(int complexity, Random random) {
    BadArrayParameterizedMethodAccessWidget widget =
        new BadArrayParameterizedMethodAccessWidget(random.nextInt(complexity + 1));
    return widget;
  }

  @Next
  public static BadArrayParameterizedMethodAccessWidget next(
      BadArrayParameterizedMethodAccessWidget current, int iteration, Random random) {
