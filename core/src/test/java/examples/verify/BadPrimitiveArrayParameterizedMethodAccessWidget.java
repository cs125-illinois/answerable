...
public class BadPrimitiveArrayParameterizedMethodAccessWidget {
  ...
  @Generator
  public static BadPrimitiveArrayParameterizedMethodAccessWidget generate(
      int complexity, Random random) {
    BadPrimitiveArrayParameterizedMethodAccessWidget widget =
        new BadPrimitiveArrayParameterizedMethodAccessWidget(random.nextInt(complexity + 1));
    return widget;
  }

  @Next
  public static BadPrimitiveArrayParameterizedMethodAccessWidget next(
      BadPrimitiveArrayParameterizedMethodAccessWidget current, int iteration, Random random) {
