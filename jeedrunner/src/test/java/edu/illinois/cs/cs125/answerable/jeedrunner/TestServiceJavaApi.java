...
public class TestServiceJavaApi {
  ...
  public void testJavaCodeQuestionCodeAnswer() throws CompilationFailed {
    answerable
        .buildNewQuestion(
            "WidgetGetter", QuestionLanguage.JAVA, TestService.WIDGET_JAVA_REFERENCE_CODE, "Widget")
        .loadNewQuestion();
    answerable
        .buildSubmission("WidgetGetter", TestService.WIDGET_JAVA_SUBMISSION_CODE)
        .submit()
        .runTests()
        .assertAllSucceeded();
  }
  ...
  public void testClassQuestionJavaCodeAnswer() throws CompilationFailed {
    answerable
        .buildNewQuestion("WidgetGetter", examples.reference.Widget.class)
  ...
  public void testJavaCodeQuestionClassAnswer() throws CompilationFailed {
    answerable
        ...
        .loadNewQuestion();
    answerable
        .buildSubmission("WidgetGetter", examples.Widget.class)
        .submit()
        .runTests()
        .assertAllSucceeded();
  }
  ...
  public void testJavaCommonCode() throws CompilationFailed {
    ...
    answerable
        .buildSubmission(
            "WidgetGetter",
            TestService.WIDGET_JAVA_SUBMISSION_CODE.replace(
                "numSprings;", "Adder.oneMore(Subtracter.oneLess(numSprings));"))
        .submit()
        .runTests()
        .assertAllSucceeded();
  }
  ...
  public void testKotlinCodeQuestionCodeAnswer() throws CompilationFailed {
    answerable
        .buildNewQuestion(
            ...
            TestService.ACCUMULATOR_KOTLIN_REFERENCE_CODE,
            "Accumulator")
        .loadNewQuestion();
    answerable
        .buildSubmission("Accumulate", TestService.ACCUMULATOR_KOTLIN_SUBMISSION_CODE)
        .submit()
        .runTests()
        .assertAllSucceeded();
  }
  ...
  public void testKotlinClassQuestionCodeAnswer() throws CompilationFailed {
    answerable
        .buildNewQuestion("Accumulate", examples.reference.Accumulator.class)
        .language(QuestionLanguage.KOTLIN)
        .loadNewQuestion();
    answerable
        .buildSubmission("Accumulate", TestService.ACCUMULATOR_KOTLIN_SUBMISSION_CODE)
        .submit()
  ...
  public void testKotlinCodeQuestionClassAnswer() throws CompilationFailed {
    answerable
        ...
        .loadNewQuestion();
    answerable
        .buildSubmission("Accumulate", examples.Accumulator.class)
        .submit()
        .runTests()
        .assertAllSucceeded();
  }
  ...
  public void testClassLoadingRestrictions() throws CompilationFailed {
    Sandbox.ClassLoaderConfiguration restriction =
        new Sandbox.ClassLoaderConfiguration(
            Collections.emptySet(),
            Collections.singleton("java.util."),
            Collections.emptySet(),
            Collections.emptySet(),
            false);
    answerable
        .buildNewQuestion(
            "Sort", QuestionLanguage.JAVA, TestService.SORT_JAVA_REFERENCE_CODE, "Sorter")
        .classLoaderConfiguration(restriction)
        .loadNewQuestion();
    TestingResults results =
        answerable
            .buildSubmission("Sort", TestService.SORT_JAVA_SUBMISSION_CODE_CHEATY)
            .submit()
            .runTests();
